...
void GenerateFightPlane(Renderer r, TUI tui)
{
    ...
    tui.AddProgressBar(r, 1, 4, 30, 0.1, '/', ColorType::Bold_Red, TerminalMode::Underline);
    tui.AddProgressBar(r, 2, 4, 30, 0.2, '/', ColorType::Bold_Blue, TerminalMode::Underline);
    tui.AddProgressBar(r, 3, 4, 30, 0.3, '/', ColorType::Bold_Magenta, TerminalMode::Underline);

    tui.AddReverseText(r, 0, 99, "Rat, LV 3");
    tui.AddText(r, 1, 97, "HP", ColorType::Bold_Red);
    tui.AddText(r, 2, 97, "MP", ColorType::Bold_Blue);
    tui.AddReverseProgressBar(r, 1, 99, 30, 1.0, '\\', ColorType::Bold_Red, TerminalMode::Underline);
    tui.AddReverseProgressBar(r, 2, 99, 30, 0.8, '\\', ColorType::Bold_Blue, TerminalMode::Underline);
...
void GenerateWalkPlane(Renderer r, TUI tui)
{
    ...
    tui.AddText(r, 2, 0, "MP", ColorType::Bold_Blue);
    tui.AddText(r, 3, 0, "EXP", ColorType::Bold_Magenta);
    tui.AddProgressBar(r, 1, 4, 30, 0.4, '/', ColorType::Bold_Red, TerminalMode::Underline);
    tui.AddProgressBar(r, 2, 4, 30, 0.5, '/', ColorType::Bold_Blue, TerminalMode::Underline);
    tui.AddProgressBar(r, 3, 4, 30, 0.6, '/', ColorType::Bold_Magenta, TerminalMode::Underline);
...
void GenerateInventoryPlane(Renderer r, TUI tui)
{
    ...
    tui.AddText(r, 2, 0, "MP", ColorType::Bold_Blue);
    tui.AddText(r, 3, 0, "EXP", ColorType::Bold_Magenta);
    tui.AddProgressBar(r, 1, 4, 30, 0.7, '/', ColorType::Bold_Red, TerminalMode::Underline);
    tui.AddProgressBar(r, 2, 4, 30, 0.8, '/', ColorType::Bold_Blue, TerminalMode::Underline);
    tui.AddProgressBar(r, 3, 4, 30, 0.9, '/', ColorType::Bold_Magenta, TerminalMode::Underline);
